...
function DashboardContentAdmin({ ongoingRound, setOngoingRound, TotalAdmins, TotalTeams, setfile }) {
  return (
    <Box>
      <Box bg="white" p={4} mt={2} borderRadius="md" width="79%" float="right" ml={2} mr={2}>
        <h1>Dashboard Content</h1>
      </Box>
      <Flex gap={4} mt={4}  bg="transparent" borderRadius="md" width="79%" float="right" ml={2} mr={2}>
        <OngoingRoundAdmin ongoingRound={ongoingRound} />
        <TotalAdminsAdmin TotalAdmins={TotalAdmins} />
        <TotalTeamsAdmin TotalTeams={TotalTeams} />
      </Flex>
      <RoundsStartAdmin ongoingRound={ongoingRound} setOngoingRound={setOngoingRound} />
