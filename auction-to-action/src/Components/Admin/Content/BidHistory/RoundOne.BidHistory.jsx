...
function RoundOneBidHistory() {
  ...
  // Fetch Round 1 bid history on component mount
  useEffect(() => {
    fetchBidHistory();
  }, []);
  ...
  const fetchBidHistory = async () => {
    ...
    try {
      ...
      // Fetch Round 1 bid history specifically
      const response = await axios.get(
        `${serverUrl}/api/admin/bid-history?round=1`,
        {
  ...
  if (isLoading) {
    return (
      <Center py={10}>
        ...
        <Text ml={4}>Loading Round 1 bid history...</Text>
      </Center>
    );
  }
    ...
    <Box>
      <TableContainer>
        <Table variant="striped" colorScheme="teal">
          <TableCaption>Round 1 Bid History - Real-time Data</TableCaption>
          <Thead>
            <Tr>
              <Th>Sl No</Th>
              <Th>Item Name</Th>
            ...
            {data.length === 0 ? (
              <Tr>
                <Td colSpan={5} textAlign="center">
                  <Text color="gray.500">No bid history found for Round 1</Text>
                </Td>
              </Tr>
            ) : (
              data.map((bid, index) => (
      ...
      <Modal isOpen={isOpen} onClose={onClose} size="lg">
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Round 1 Bid Details</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            {selectedBid && (
      ...
      <Modal isOpen={isEditOpen} onClose={onEditClose} size="lg">
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Edit Round 1 Bid</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            {editingBid && (
              <VStack spacing={4}>
            ...
            <AlertDialogBody>
              ...
              {selectedBid && (
                <Box mt={2} p={2} bg="gray.100" borderRadius="md">
                  <Text>
                    <strong>Item:</strong> {selectedBid.itemName}
                  </Text>
                  <Text>
